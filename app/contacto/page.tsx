...
export const metadata: Metadata = {
  title: { absolute: "Contacto | Solicitar un estudio de mercado en Uruguay" },
  description:
    "Contactanos para solicitar un estudio de mercado, una investigación a medida o una consulta estratégica. Respondemos a la brevedad. Montevideo, Uruguay.",
  openGraph: {
    title: "Contacto | Solicitar un estudio de mercado en Uruguay",
    description:
      "Completá el formulario o escribinos por WhatsApp. Te ayudamos a definir el mejor tipo de estudio para tu necesidad.",
    type: "website",
  },
};
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <a href={CONTACT.phoneHref} className="text-base text-ink hover:text-accent transition-colors">
          {CONTACT.phone}
        </a>
      </div>
      ...
      <div>
        ...
        <a href={CONTACT.emailHref} className="text-base text-ink hover:text-accent transition-colors break-all">
          {CONTACT.email}
        </a>
      </div>
