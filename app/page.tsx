  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] flex items-center bg-bg py-24 md:py-0 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse 65% 55% at 72% 50%, rgba(61,107,245,0.12) 0%, transparent 70%)",
      }} />
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse 45% 35% at 15% 20%, rgba(61,107,245,0.04) 0%, transparent 65%)",
      }} />
      <div className="absolute inset-0 pointer-events-none" style={{
      ...
      <div className="max-w-6xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-16 items-center relative z-10">
        <div className="max-w-lg">
          <div className="inline-flex items-center gap-2 mb-8 px-3 py-1.5 rounded-full"
            style={{ background: "rgba(61,107,245,0.1)", border: "1px solid rgba(61,107,245,0.25)" }}>
          ...
          <h1 className="font-display font-bold text-display-xl text-ink mb-6 leading-[1.08]">
            ...
            <span style={{
              backgroundImage: "linear-gradient(135deg, #7BA4FF 0%, #3D6BF5 55%, #1A45CC 100%)",
          ...
          <div className="flex flex-wrap gap-2 mt-9 pt-7"
            ...
            {["Estudios prontos", "Estudios ad hoc", "Consultoría estratégica"].map((s) => (
              <span
                ...
                style={{
                  border: "1px solid rgba(61,107,245,0.3)",
                  background: "rgba(61,107,245,0.05)",
                }}
              >
            ...
            {trustItems.map((item) => (
              <div key={item.label} className="glass-card rounded-sm p-6 flex gap-4 transition-all duration-300 hover:-translate-y-0.5">
                <div className="w-9 h-9 rounded-sm flex items-center justify-center flex-shrink-0 mt-0.5"
                  style={{ background: "rgba(61,107,245,0.14)", color: "#3D6BF5" }}>
                  {item.icon}
                </div>
                <div>
            ...
            <Reveal key={s.number} delay={i * 0.1} className="flex flex-col">
              <div className="service-card-v2 group flex flex-col flex-1 rounded-sm overflow-hidden hover:-translate-y-1">
                <div className="h-[110px] overflow-hidden flex items-center justify-center relative"
                  style={{ background: "rgba(9,10,20,0.85)", borderBottom: "1px solid rgba(61,107,245,0.12)" }}>
                  {s.headerSvg}
                  <span className="absolute top-3 right-4 text-4xl font-bold tabular-nums leading-none"
                    style={{
                      backgroundImage: "linear-gradient(135deg, rgba(61,107,245,0.22) 0%, rgba(123,164,255,0.08) 100%)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                    }}>
                ...
                <div className="p-7 flex flex-col flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 rounded-sm flex items-center justify-center text-accent transition-all duration-300 group-hover:scale-110"
                      style={{ background: "rgba(61,107,245,0.14)" }}>
                      {s.icon}
                    </div>
...
function ScatterSVG() {
  return (
    <svg viewBox="0 0 240 110" fill="none" className="w-full h-full opacity-80" xmlns="http://www.w3.org/2000/svg">
      {[0,1,2,3].map(i => (
        <line key={i} x1="20" y1={15 + i * 22} x2="220" y2={15 + i * 22} stroke="#3D6BF5" strokeWidth="0.4" strokeOpacity="0.25" />
      ))}
      {[0,1,2,3,4].map(i => (
        <line key={i} x1={20 + i * 50} y1="10" x2={20 + i * 50} y2="100" stroke="#3D6BF5" strokeWidth="0.4" strokeOpacity="0.2" />
      ))}
      <circle cx="48"  cy="82" r="5" fill="#3D6BF5" opacity="0.7" />
      <circle cx="78"  cy="62" r="6" fill="#7BA4FF" opacity="0.6" />
      <circle cx="108" cy="72" r="4" fill="#3D6BF5" opacity="0.55" />
      <circle cx="135" cy="44" r="7" fill="#7BA4FF" opacity="0.55" />
      <circle cx="162" cy="54" r="5" fill="#3D6BF5" opacity="0.7" />
      <circle cx="192" cy="32" r="6" fill="#7BA4FF" opacity="0.65" />
      <circle cx="90"  cy="88" r="3" fill="#3D6BF5" opacity="0.45" />
      <circle cx="175" cy="68" r="4" fill="#5B7EE8" opacity="0.5" />
      <line x1="40" y1="92" x2="205" y2="24" stroke="#7BA4FF" strokeWidth="1" strokeDasharray="5 4" strokeOpacity="0.4" />
    </svg>
  );
}
...
function MatrixSVG() {
  return (
    <svg viewBox="0 0 240 110" fill="none" className="w-full h-full opacity-80" xmlns="http://www.w3.org/2000/svg">
      <line x1="20" y1="95" x2="215" y2="95" stroke="#3D6BF5" strokeWidth="1" strokeOpacity="0.4" />
      <line x1="20" y1="10" x2="20"  y2="100" stroke="#3D6BF5" strokeWidth="1" strokeOpacity="0.4" />
      <polygon points="215,92 220,95 215,98" fill="#3D6BF5" opacity="0.4" />
      <polygon points="17,10 20,5 23,10"    fill="#3D6BF5" opacity="0.4" />
      <line x1="117" y1="10" x2="117" y2="95" stroke="#3D6BF5" strokeWidth="0.5" strokeDasharray="4 4" strokeOpacity="0.2" />
      <line x1="20" y1="52" x2="215" y2="52" stroke="#3D6BF5" strokeWidth="0.5" strokeDasharray="4 4" strokeOpacity="0.2" />
      <circle cx="162" cy="26" r="16" fill="rgba(61,107,245,0.12)" stroke="#7BA4FF" strokeWidth="1" strokeOpacity="0.55" />
      <circle cx="162" cy="26" r="6"  fill="#7BA4FF" opacity="0.65" />
      <circle cx="58"  cy="74" r="10" fill="rgba(61,107,245,0.15)" stroke="#3D6BF5" strokeWidth="0.8" strokeOpacity="0.4" />
      <circle cx="160" cy="74" r="12" fill="rgba(61,107,245,0.1)"  stroke="#3D6BF5" strokeWidth="0.8" strokeOpacity="0.3" />
      <circle cx="62"  cy="30" r="8"  fill="rgba(61,107,245,0.08)" stroke="#3D6BF5" strokeWidth="0.8" strokeOpacity="0.3" />
      <path d="M88 68 Q110 48 138 32" stroke="#7BA4FF" strokeWidth="1.5" strokeOpacity="0.5" fill="none" />
      <polygon points="134,29 142,30 138,37" fill="#7BA4FF" opacity="0.5" />
    </svg>
  );
}
...
function DocumentSVG() {
  return (
    <svg viewBox="0 0 240 110" fill="none" className="w-full h-full opacity-80" xmlns="http://www.w3.org/2000/svg">
      <rect x="75"  y="55" width="110" height="52" rx="2" fill="rgba(61,107,245,0.07)" stroke="#3D6BF5" strokeWidth="0.7" strokeOpacity="0.3" />
      <rect x="63"  y="42" width="110" height="52" rx="2" fill="rgba(61,107,245,0.1)"  stroke="#3D6BF5" strokeWidth="0.7" strokeOpacity="0.4" />
      <rect x="50"  y="28" width="110" height="52" rx="2" fill="rgba(7,8,16,0.95)"    stroke="#3D6BF5" strokeWidth="1"   strokeOpacity="0.6" />
      <line x1="64" y1="44" x2="146" y2="44" stroke="#7BA4FF" strokeWidth="1"   strokeOpacity="0.6" />
      <line x1="64" y1="55" x2="138" y2="55" stroke="#3D6BF5" strokeWidth="0.8" strokeOpacity="0.4" />
      <line x1="64" y1="64" x2="142" y2="64" stroke="#3D6BF5" strokeWidth="0.8" strokeOpacity="0.3" />
      <line x1="64" y1="73" x2="120" y2="73" stroke="#3D6BF5" strokeWidth="0.8" strokeOpacity="0.25" />
      <circle cx="148" cy="57" r="13" fill="rgba(61,107,245,0.18)" stroke="#7BA4FF" strokeWidth="1" strokeOpacity="0.65" />
      <polyline points="142,57 146,62 156,51" stroke="#7BA4FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.9" />
    </svg>
  );
}
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-6 z-10">
            <div className="h-px w-full" style={{ borderTop: "1px dashed rgba(61,107,245,0.4)" }} />
          </div>
          ...
          <Reveal>
            <div className="relative">
              <span className="absolute -left-6 -top-4 text-8xl font-bold leading-none pointer-events-none select-none"
                style={{ color: "rgba(61,107,245,0.1)", fontFamily: "Georgia, serif" }}>
                [
              </span>
          ...
          <Reveal delay={0.1}>
            <div className="space-y-4">
              ...
              <div className="rounded-sm p-6 relative overflow-hidden"
                ...
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-base" aria-hidden="true">✓</span>
                  <p className="text-xs font-bold uppercase tracking-[0.15em]" style={{ color: "rgba(61,107,245,0.8)" }}>
                    Nuestra ventaja
                  </p>
                </div>
                <p className="text-sm text-muted leading-relaxed">
...
function CtaSection() {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden"
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse 75% 65% at 50% 110%, rgba(61,107,245,0.4) 0%, transparent 65%)",
      }} />
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse 50% 30% at 50% 0%, rgba(61,107,245,0.06) 0%, transparent 70%)",
      }} />
      <div className="absolute top-0 left-0 right-0 h-px pointer-events-none"
        style={{ background: "linear-gradient(to right, transparent 0%, rgba(61,107,245,0.5) 50%, transparent 100%)" }} />
      ...
      <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
        <Reveal>
          ...
          <h2 className="font-display font-bold text-display-lg text-white mb-6 leading-tight">
            ...
            <span style={{
              backgroundImage: "linear-gradient(135deg, #7BA4FF 0%, #3D6BF5 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
            }}>
