    ...
    <>
      ...
      <div className="hidden md:block relative">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(to bottom, rgba(46,125,200,0.4) 0px, rgba(46,125,200,0.4) 6px, transparent 6px, transparent 14px)",
          }}
        />
                ...
                <div className="grid grid-cols-[1fr_80px_1fr] items-center">
                  ...
                  <div className="flex justify-center z-10">
                    <div
                      ...
                      style={{
                        background: "#071A33",
                        border: "1.5px solid rgba(46,125,200,0.7)",
                        boxShadow: "0 0 14px rgba(46,125,200,0.2)",
                      }}
                    >
                      <span
          ...
          <Reveal key={s.n} delay={i * 0.08}>
            <div className="relative mb-5">
              <div
                ...
                style={{
                  background: "#071A33",
                  border: "1.5px solid rgba(46,125,200,0.6)",
                }}
              >
                <span
